...
- Checks its preconditions directly and runs only when a remote is present and
  there are no pending modified/untracked files or status problems to report.
